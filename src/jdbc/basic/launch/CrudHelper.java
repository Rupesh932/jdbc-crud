...
public class CrudHelper {
	...
	public static Object getColumnValue(String colType, String colName) {
		...
		case Constants.ColumnType.NUMERIC -> InputManager.decimalInput("enter farctional value for '" + colName + "' field");
...
public static Map<String,String>prepareColumnMeta(String tableName) {
	...
	for (int i = 1; i <= colCount; i++) {
		String colName = validName("Enter name for column " + i + " of table '" + tableName + "':");
		String colConstrain = InputManager.stringInput("Enter constraints for column '" + colName + "' (e.g., VARCHAR(20) NOT NULL UNIQUE):");
